        ...
        <div className="flex items-center gap-2 px-2 py-2">
          ...
          {!collapsed && (
            <div className="leading-tight">
              <div className="font-display text-base font-semibold text-sidebar-foreground">Shadrach LOANS</div>
              <div className="text-[11px] uppercase tracking-wider text-sidebar-foreground/60">Loan Manager</div>
            </div>
          )}
        </div>
      </SidebarHeader>
