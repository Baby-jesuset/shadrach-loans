...
import { AlertTriangle, BellRing, CheckCircle2, Calendar, Plane } from "lucide-react";
...
const kindMeta: Record<AppNotification["kind"], { icon: typeof Calendar; tone: string }> = {
  ...
  travel:    { icon: Plane,         tone: "bg-primary/10 text-primary" },
};
