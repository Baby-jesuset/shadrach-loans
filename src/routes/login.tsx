...
export const Route = createFileRoute("/login")({
  component: LoginPage,
  head: () => ({ meta: [{ title: "Sign in — Shadrach LOANS" }] }),
});

function LoginPage() {
  const { login } = useAuth();
  const navigate = useNavigate();
  const [email, setEmail] = useState("manager@shadrach-loans.co.ug");
      ...
      <div className="relative hidden overflow-hidden bg-sidebar text-sidebar-foreground lg:block">
        ...
        <div className="relative flex h-full flex-col p-12">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-display text-lg font-semibold">shadrach LOANS</div>
